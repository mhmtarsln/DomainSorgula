...
{
    class DomainDotCom : CheckService
    {
        public DomainDotCom()
        {
            base.ServiceUrl = "https://registration.domain.com/domains/search/{0}?suggestions=0&aftermarket=false&propertyID=52&searchTerm={1}&tlds={2}&currency=USD";
